function [ Eeff ] = compute_Eeff_Gibbs( Eb1, Eb2, Et1, Et2, l1, l2, k1, k2, n)
...
%   Et2, l1, l2, k1 et k2. On impose la contrainte t_imp aux deux fibres en x = nl, 
%   et le d�placement utilis� pour le calcul du module d'Young effectif est
%   delta = (u_b(x=nl) + u_t(x=nl))/2
